...
- [ ] **App Store distribution**: The architecture is AOT-compatible, but archive, privacy, signing, validation, and acceptance gates remain. [tracker](trackers/distribution.md)
