...
- [ ] **Swift ABI and AOT artifacts**: The sample C ABI, static XCFramework, and same-tuple multi-library composition work; production ownership, cross-version composition, and final release packaging remain. [tracker](trackers/swift-abi-artifacts.md)
