...
- [ ] **Metal**: Mixed — General arguments, true O0, and line-table debug pass host, Simulator, and physical-iPad gates; full debug, current-AIR targets, and existing tensor paths need enablement, while atomics/synchronization/simdgroups need verification. [tracker](trackers/metal.md)
