...
- [ ] **Metal**: Mixed — General arguments and true O0/line-table/full-debug builds pass host, Simulator, and physical-iPad gates; current-AIR targets and existing tensor paths need enablement, while atomics/synchronization/simdgroups need verification. [tracker](trackers/metal.md)
