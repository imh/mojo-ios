...
- [ ] **Globals, TLS, and atomics**: Broader initialization, thread-local state, memory-ordering, and contention families lack the complete base-matrix evidence; the next gate must add ordinary upstream-family fixtures or named target diagnostics.
